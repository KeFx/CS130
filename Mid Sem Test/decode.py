...
def decode_string(string):
    ...
    index_closing_bracket_to_match_the_first_left_bracket = get_closing_bracket_idx(string, first_left_bracket_index)

    pre_bracket = string[0:first_left_bracket_index]
    inner_bracket = string[first_left_bracket_index + 1 : index_closing_bracket_to_match_the_first_left_bracket]
    post_bracket = string[index_closing_bracket_to_match_the_first_left_bracket+1:]
    ...
    multiplier = int(get_multipier_from(pre_bracket))
